...
//	const uint8_t para_flash_area[128*1024] __attribute__((at(0x08100000 + 6*128*1024)));

	const uint8_t para_flash_area_6[128*1024] __attribute__((at(ADDR_FLASH_SECTOR_6_BANK2)));
	const uint8_t para_flash_area_5[128*1024] __attribute__((at(ADDR_FLASH_SECTOR_5_BANK2)));
